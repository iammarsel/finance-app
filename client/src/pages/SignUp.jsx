...
function SignUp() {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-gradient-to-tl from-green-300 to-white">
    <div className="flex-col rounded-xl w-96 bg-gray-800 text-white">
      <h1 className="text-2xl my-12 text-center">Sign Up to Financify</h1>
      <Formik
      ...
      >
        <Form className="">
          ...
          <label className="text-base pl-[10%]" >Username: </label>
          ...
          <div className="h-7 flex items-center space-x-4">
          <label className="text-base pl-[10%]">Email Address: </label>
          <Field
            autoComplete="off"
            id="inputCreatePost"
            className="h-7 rounded-lg border mr-6 border-slate-300 text-sm bg-transparent outline-green-300 shadow-md"
          ...
          <button type="submit" className="rounded-xl align-middle justify-center text-center mx-[40%] mb-10 bg-green-400 mt-5 text-lg w-20">Sign Up</button>
        </Form>
      </Formik>
    </div>
    </div>
